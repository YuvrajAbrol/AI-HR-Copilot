...
class HRAgentsModel(BaseModel):
    ...
    New code should extend pydantic.BaseModel directly instead of HRAgentsModel.

    Existing code that extends HRAgentsModel will continue to work, but
    migration to BaseModel is recommended.
    """


class DiscriminatedUnionMixin(HRAgentsModel):
