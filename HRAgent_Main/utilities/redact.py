...
Copies / consumers (keep in sync when changing):
  - HRAgents/runtime-api  →  utils/redact.py  (partial copy)
  - All-Hands-AI/HRAgents →  imports directly
"""
...
_API_KEY_LITERAL_RE = re.compile(
    ...
    r"|sk-oh-[A-Za-z0-9]{20,}"  # HRAgents session tokens
...
def redact_api_key_literals(text: str) -> str:
    ...
    HRAgents session tokens, etc.) anywhere in the text.
