...
from models.llm.exceptions import LLMResponseError
from models.llm.utils.metrics import Metrics


class HRAgentsJSONEncoder(json.JSONEncoder):
...
_json_encoder = HRAgentsJSONEncoder()
...
def dumps(obj, **kwargs):
    ...
    if "cls" not in encoder_kwargs:
        encoder_kwargs["cls"] = HRAgentsJSONEncoder
