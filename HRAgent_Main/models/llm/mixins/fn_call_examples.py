...
# interface designed in HRAgent/agenthub/agent/function_calling.py
...
Requirement already satisfied: Jinja2>=3.1.2 in /home/HRAgent/.local/lib/python3.10/site-packages (from flask) (3.1.3)
Requirement already satisfied: MarkupSafe>=2.0 in /home/HRAgent/.local/lib/python3.10/site-packages (from Jinja2>=3.1.2->flask) (2.1.5)
