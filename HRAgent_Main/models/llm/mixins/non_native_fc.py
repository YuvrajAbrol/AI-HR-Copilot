...
from models.llm.exceptions import LLMNoResponseError
from models.llm.mixins.fn_call_converter import (
    STOP_WORDS,
...
class NonNativeToolCallingMixin:
    ...
    def pre_request_prompt_mock(
        ...
        add_iclex = not any(
            s in self.model for s in ("HRAgent-lm", "devstral", "nemotron")
        )
