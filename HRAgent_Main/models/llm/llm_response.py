...
with HRAgents-native types, eliminating the need for consumers to work directly
with LiteLLM types.
"""
...
from models.llm.message import Message
...
class LLMResponse(BaseModel):
    ...
    only HRAgents-native types to consumers while preserving access to the
    raw LiteLLM response for internal use.

    Attributes:
        message: The completion message converted to HRAgents Message type
