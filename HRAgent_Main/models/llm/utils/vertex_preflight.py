...
`google-cloud-aiplatform` is an optional extra (`HRAgent-sdk[vertex]`). When a
...
from models.llm.exceptions import LLMBadRequestError


_INSTALL_HINT = (
    "Vertex AI partner models require the Vertex SDK. "
    'Install with: pip install "HRAgent-sdk[vertex]"'
)
