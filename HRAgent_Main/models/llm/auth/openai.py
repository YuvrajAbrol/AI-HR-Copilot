...
from models.llm.auth.credentials import (
    CredentialStore,
    OAuthCredentials,
    get_credentials_dir,
)
...
<html>
<head>
  <title>HRAgents - Authorization Successful</title>
  <style>
...
<body>
  <div class="container">
    ...
    <p>You can close this window and return to HRAgents.</p>
  </div>
...
<html>
<head>
  <title>HRAgents - Authorization Failed</title>
  <style>
    body { font-family: system-ui, sans-serif; display: flex;
           justify-content: center; align-items: center; height: 100vh;
           margin: 0; background: #1a1a2e; color: #eee; }
    ...
    def create_llm(
        ...
        **llm_kwargs: Any,
        ...
        extra_headers: dict[str, str] = {
            ...
            "User-Agent": f"HRAgent-sdk ({platform.system()}; {platform.machine()})",
        }
        if account_id:
...
async def subscription_login_async(
    ...
    **llm_kwargs: Any,
    ...
    Example:
        >>> import asyncio
        >>> from models.llm.auth import subscription_login_async
