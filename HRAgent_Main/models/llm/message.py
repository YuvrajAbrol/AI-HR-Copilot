...
from utilities import DEFAULT_TEXT_CONTENT_LIMIT, maybe_truncate
from utilities.deprecation import handle_deprecated_model_fields
...
class Message(BaseModel):
    ...
    def to_responses_dict(self, *, vision_enabled: bool) -> list[dict[str, Any]]:
        ...
        from models.llm.utils.responses_serialization import (
