...
from context.prompts import render_template
from context.prompts.presets import create_registry
from context.prompts.section import PromptContext
...
from security.validation.secret import SecretSource, SecretValue
from skills import (
    Skill,
    SkillKnowledge,
...
class AgentContext(BaseModel):
    ...
    load_user_skills: bool = Field(
        default=False,
        description=(
            "Whether to automatically load user skills from ~/.HRAgent/skills/ "
            "and ~/.HRAgent/microagents/ (for backward compatibility). "
        ),
        json_schema_extra={"acp_compatible": True},
    )
    load_public_skills: bool = Field(
        default=False,
        description=(
            "Whether to automatically load skills from the public HRAgents "
            "skills repository at https://github.com/HRAgents/extensions. "
    ...
    load_project_skills: bool = Field(
        ...
        description=(
            ...
            "workspace (e.g. .HRAgent/skills/, AGENTS.md). Unlike "
    ...
    load_memory: bool = Field(
        ...
        description=(
            ...
            "~/.HRAgent/memory/ and <workspace>/.HRAgent/memory/) into the "
