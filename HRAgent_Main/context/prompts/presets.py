...
omits the default HRAgents sections. The dynamic-tier sections are **shared** --
...
from context.prompts.section import PromptSection
from context.prompts.sections.dynamic import (
...
from context.prompts.sections.planning import PlanningSection
from context.prompts.sections.static import (
    BrowserSection,
    CodeQualitySection,
    EfficiencySection,
...
def create_registry(preset: PromptPreset = PromptPreset.DEFAULT) -> PromptRegistry:
    ...
    ``DEFAULT`` is the standard HRAgents composition; ``PLANNING`` is the read-only
