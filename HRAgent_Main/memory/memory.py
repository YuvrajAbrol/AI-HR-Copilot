...
Reads the agent-maintained ``MEMORY.md`` indexes -- ``~/.HRAgent/memory/``
(user tier) and ``<workspace>/.HRAgent/memory/`` (project tier) -- into one
...
MEMORY_INDEX_RELPATH: Final[str] = ".HRAgent/memory/MEMORY.md"
