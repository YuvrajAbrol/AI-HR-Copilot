...
from mcp_integration.config import coerce_mcp_config, dump_mcp_config
from plugins.plugin import Plugin
from plugins.types import PluginSource
from skills.utils import SecretLookup, expand_mcp_variables
