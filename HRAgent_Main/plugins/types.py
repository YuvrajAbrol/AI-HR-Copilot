...
#: See https://github.com/HRAgents/software-agent-sdk/issues/1745 for LSP support.
...
#: See core.execution.hooks.HookConfig for the full structure.
...
class CommandDefinition(BaseModel):
    ...
    def to_skill(self, plugin_name: str) -> Skill:
        ...
        """
        from skills.skill import Skill
        from skills.trigger import KeywordTrigger
