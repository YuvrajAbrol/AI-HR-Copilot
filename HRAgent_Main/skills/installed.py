"""Installed skills management for HRAgents SDK.
...
from skills.utils import find_skill_md
from utilities.path import to_posix_path


if TYPE_CHECKING:
    from plugins.marketplace import Marketplace, MarketplaceRegistration
...
DEFAULT_INSTALLED_SKILLS_DIR = Path.home() / ".HRAgent" / "skills" / "installed"
...
def load_marketplace_standalone_skills(
    ...
    """
    from plugins import resolve_source_path
