"""Skill management for HRAgents SDK.
...
- `load_user_skills` - Load skills from ~/.HRAgent/skills/
- `load_public_skills` - Load skills from the public HRAgents extensions repo
...
# Fetch utilities
from skills.fetch import SkillFetchError, fetch_skill_with_resolution

# Installed skills management
from skills.installed import (
    InstalledSkillInfo,
    disable_skill,
    enable_skill,
    get_installed_skill,
