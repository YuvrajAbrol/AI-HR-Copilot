...
from security.validation.secret import SecretValue
from tools.client_tool import ClientToolSpec
from utilities.redact import redact_url_credentials
...
class Conversation:
    """Factory class for creating conversation instances with HRAgents agents.
    ...
    def __new__(
        ...
        *,
        ...
        from core.conversation.impl.local_conversation import LocalConversation
        from core.conversation.impl.remote_conversation import (
            RemoteConversation,
        )
