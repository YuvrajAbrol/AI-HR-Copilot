...
from core.conversation.resource_lock_manager import ResourceLockManager
from core.execution.event.llm_convertible import AgentErrorEvent
from runtime.telemetry.logger import get_logger


if TYPE_CHECKING:
    from core.execution.event.base import Event
    from core.execution.event.llm_convertible import ActionEvent
    from tools.tool import DeclaredResources, ToolDefinition
