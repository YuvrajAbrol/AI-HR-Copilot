...
Usage::
    ...
    from core.orchestration.goal import run_goal

    outcome = run_goal(conversation, "make pytest pass for mathx.py", judge_llm)
"""

from core.orchestration.goal.controller import (
    GoalContinue,
    GoalController,
    GoalDone,
    GoalOutcome,
...
from core.orchestration.goal.judge import GoalVerdict, judge_goal
from core.orchestration.goal.runner import run_goal
