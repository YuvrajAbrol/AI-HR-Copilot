"""Plugins router for HRAgents Agent Server.
...
from runtime.server.plugins_service import (
...
from plugins import InstalledPluginInfo, Plugin, PluginFetchError
...
class InstallPluginRequest(BaseModel):
    ...
    source: str = Field(
        ...
        description=(
            ...
            "'github:HRAgents/extensions/plugins/city-weather', '/path/to/plugin'"
        ),
    )
    ref: str | None = Field(
...
def get_marketplace_catalog() -> MarketplaceCatalogResponse:
    ...
    from the HRAgents extensions repository marketplace, each with attachable
