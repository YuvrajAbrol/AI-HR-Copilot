...
from runtime.server.conversation_lease import DEFAULT_LEASE_TTL_SECONDS
from runtime.server.env_parser import (
    MISSING,
...
CONFIG_PATH_ENV = "HRAgentS_AGENT_SERVER_CONFIG_PATH"
DEFAULT_CONFIG_PATH = Path("workspace/HRAgent_agent_server_config.json")
# 20 minutes, matching the idle timeout used by HRAgents Cloud.
