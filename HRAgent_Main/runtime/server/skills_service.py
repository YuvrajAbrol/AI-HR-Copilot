"""Skills service for HRAgents Agent Server.
...
Skill Sources:
- Public skills: registered marketplace plugins or GitHub HRAgents/extensions
- User skills: ~/.HRAgent/skills/ and ~/.HRAgent/microagents/
- Project skills: {workspace}/.HRAgent/skills/, .cursorrules, agents.md
- Organization skills: {org}/.HRAgent or {org}/HRAgent-config
...
def load_org_skills_from_url(
    ...
    # the same org_name (e.g. {login}/.HRAgent and {login}/.agents), and
    ...
    if working_dir:
        ...
        temp_dir = Path(tempfile.mkdtemp(prefix=f"HRAgent_org_skills_{org_name}_"))
...
def discover_profile_skills() -> list[Skill]:
    """Skill catalog an HRAgents profile launches with (#4017).
...
def service_install_skill(
    ...
    Args:
        source: Skill source - git URL, GitHub shorthand, or local path.
            ...
            - GitHub URL: https://github.com/HRAgents/extensions/tree/main/skills/github
            - GitHub shorthand: github:HRAgents/extensions/skills/github
        ...
        installed_dir: Directory for installed skills.
            Defaults to ~/.HRAgent/skills/installed/.
