"""Sub-agents router for HRAgents Agent Server.
...
from tools.preset.default import discover_builtin_agents
...
class SubAgentsRequest(BaseModel):
    ...
    load_user: bool = Field(
        default=True,
        description="Load user agents from ~/.agents/agents and ~/.HRAgent/agents",
    )
