...
See: https://github.com/HRAgents/software-agent-sdk/issues/2523
"""
...
from runtime.server.bash_service import BashEventService
from runtime.server.config import Config, TelemetrySpec, WebhookSpec
from runtime.server.conversation_service import ConversationService
from runtime.server.server_details_router import mark_initialization_complete
...
class InitService:
    ...
    async def initialize(self, req: InitRequest) -> InitStatus:
        ...
        try:
            ...
            from runtime.server import conversation_service as cs_mod
            ...
            from runtime.server.api import _get_root_path
