...
from runtime.persistence.models import SettingsUpdatePayload
from runtime.telemetry import notify_misc_settings_changed
...
def _get_agent_settings_schema() -> SettingsSchema:
    ...
    # ``HRAgentsAgentSettings`` and ``ACPAgentSettings``; the combined
