...
from runtime.telemetry.observability.utils import get_env


if TYPE_CHECKING:
    from core.conversation.types import TraceMetadataValue
...
def init_laminar_for_external():
    ...
    Example:
        ```python
        from runtime.telemetry.observability import init_laminar_for_external
        from lmnr import Laminar
