...
These models mirror the structure used in HRAgents app-server for consistency,
...
class Secrets(BaseModel):
    ...
    Unlike HRAgents app-server which also stores provider tokens,
...
#   configuration.settings.api_models (SecretCreateRequest, SecretItemResponse, etc.)
