...
Thank you for helping improve the HRAgents Software Agent SDK.
...
- [HRAgents-CLI](https://github.com/HRAgents/HRAgents-CLI) (client)
- [HRAgents app-server](https://github.com/HRAgents/HRAgents/blob/main/HRAgent/app_server/README.md) (client)
- [HRAgents Enterprise](https://github.com/HRAgents/HRAgents/blob/main/enterprise/README.md) (client)

The SDK itself has a Python interface. In addition, the
[agent-server](https://docs.HRAgent.dev/sdk/guides/agent-server/overview) is the
...
The architecture of HRAgents V0 was too monolithic to support multiple applications built into it,
as CLI, evaluation scripts, web server were, and built on it, as HRAgents Cloud was.

If you’re interested in the deeper background and lessons learned, see our write-up:
[HRAgents: An Open Platform for AI Software Developers as Generalist Agents](https://arxiv.org/abs/2511.03690)
...
- **HRAgents SDK is its own thing**: its downstream are client applications.
...
- [HRAgent-sdk/HRAgent/sdk/subagent/AGENTS.md](HRAgent-sdk/HRAgent/sdk/subagent/AGENTS.md) for file-based subagent discovery, precedence, and task handoff conventions
...
Join us on Slack: https://HRAgent.dev/joinslack
