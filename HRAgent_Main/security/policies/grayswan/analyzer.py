"""GraySwan Cygnal security analyzer for HRAgents SDK.
...
from core.execution.event import ActionEvent, LLMConvertibleEvent
from runtime.telemetry.logger import get_logger
from security.policies.analyzer import SecurityAnalyzerBase
from security.policies.grayswan.utils import convert_events_to_openai_messages
...
class GraySwanAnalyzer(SecurityAnalyzerBase):
    ...
    Example:
        >>> from security.policies.grayswan import GraySwanAnalyzer
