"""Utility for converting HRAgents SDK events to OpenAI message format.
...
from models.llm import ImageContent, TextContent, content_to_str
...
def convert_events_to_openai_messages(
    ...
    """Convert HRAgents SDK events to OpenAI message format for LLM APIs.
