...
from context.condenser import CondenserBase, NoOpCondenser
from core.execution.hooks.config import HookConfig
...
class AgentDefinition(BaseModel):
    ...
    def get_confirmation_policy(self) -> ConfirmationPolicyBase | None:
        ...
        match self.permission_mode:
            case "always_confirm":
                from security.policies.confirmation_policy import AlwaysConfirm

                return AlwaysConfirm()
            case "never_confirm":
                from security.policies.confirmation_policy import NeverConfirm

                return NeverConfirm()
            case "confirm_risky":
                from security.policies.confirmation_policy import ConfirmRisky
